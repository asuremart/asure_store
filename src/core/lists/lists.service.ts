...
export class ListsService extends Api {
  ...
  public getWidgetDetail(params): Observable<any> {
    this.base = this.getBaseUrl();
    return this.http.get(this.base + 'list/widget-detail/' + params.widgetId, { params: params });
  }
  public getWidgetDetailCount(params): Observable<any> {
    this.base = this.getBaseUrl();
    return this.http.get(this.base + 'list/widget-detail/' + params.widgetId, { params: params });
  }
