...
export const ActionTypes = {
  ...
  WIDGET_DETAIL: type('[widget detail] widget detail'),
  WIDGET_DETAIL_SUCCESS: type('[widget detail] widget detail success'),
  WIDGET_DETAIL_FAIL: type('[widget detail] widget detail fail'),

  WIDGET_DETAIL_COUNT: type('[widget detail] widget detail count'),
  WIDGET_DETAIL_COUNT_SUCCESS: type('[widget detail] widget detail count success'),
  WIDGET_DETAIL_COUNT_FAIL: type('[widget detail] widget detail count fail'),
...
export class GetProductSearchListFail implements Action {
 ...
 /* WIDGET LIST*/
 export class widgetDetails implements Action {
  type = ActionTypes.WIDGET_DETAIL;

  constructor(public payload: any) {}
}

export class widgetDetailsSuccess implements Action {
  type = ActionTypes.WIDGET_DETAIL_SUCCESS;

  constructor(public payload: any) {}
}

export class widgetDetailsFail implements Action {
  type = ActionTypes.WIDGET_DETAIL_FAIL;

  constructor(public payload: any) {}
}

/* WIDGET LIST*/
export class widgetDetailsCount implements Action {
  type = ActionTypes.WIDGET_DETAIL_COUNT;

  constructor(public payload: any) {}
}

export class widgetDetailsCountSuccess implements Action {
  type = ActionTypes.WIDGET_DETAIL_COUNT_SUCCESS;

  constructor(public payload: any) {}
}

export class widgetDetailsCountFail implements Action {
  type = ActionTypes.WIDGET_DETAIL_COUNT_FAIL;
