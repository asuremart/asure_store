...
export interface ListsState extends Map<string, any> {
  ...
  widgetDetailLoading: boolean;
  widgetDetailLoaded: boolean;
  widgetDetailFailed: boolean;
  widgetDetail: any;

  widgetDetailCountLoading: boolean;
  widgetDetailCountLoaded: boolean;
  widgetDetailCountFailed: boolean;
  widgetDetailCount: any;
