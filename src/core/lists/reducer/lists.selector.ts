...
export const widgetDetail = createSelector(getState, fromList.widgetDetail);
export const widgetDetailLoading = createSelector(getState, fromList.widgetDetailLoading);
export const widgetDetailLoaded = createSelector(getState, fromList.widgetDetailLoaded);
export const widgetDetailFailed = createSelector(getState, fromList.widgetDetailFailed);

export const widgetDetailCount = createSelector(getState, fromList.widgetDetailCount);
export const widgetDetailCountLoading = createSelector(getState, fromList.widgetDetailCountLoading);
export const widgetDetailCountLoaded = createSelector(getState, fromList.widgetDetailCountLoaded);
export const widgetDetailCountFailed = createSelector(getState, fromList.widgetDetailCountFailed);
