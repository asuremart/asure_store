...
export function reducer(
  ...
  switch (type) {
    ...
    case actions.ActionTypes.GET_SubCATEGORY_LIST_SUCCESS: {
      let tempList = [];
      if (payload && payload.data && payload.data.children) {
    ...
    case actions.ActionTypes.WIDGET_PRODUCT_LIST: {
      const tempWidgetProductList = payload.refresh ? [] : (state.widgetProductList ? state.widgetProductList : []);
      return Object.assign({}, state, {
        widgetProductList: tempWidgetProductList,
    ...
    case actions.ActionTypes.WIDGET_PRODUCT_LIST_SUCCESS: {
      const tempWidgetProductList = state.widgetProductList ? state.widgetProductList : [];
      if (payload && payload.data && payload.data.length > 0) {
        payload.data.forEach(element => {
          tempWidgetProductList.push(element);
        });
      }
      return Object.assign({}, state, {
    ...
    case actions.ActionTypes.WIDGET_DETAIL: {
      return Object.assign({}, state, {
        widgetDetailLoading: true,
        widgetDetailLoaded: false,
        widgetDetailFailed: false,
      });
    }

    case actions.ActionTypes.WIDGET_DETAIL_SUCCESS: {
      return Object.assign({}, state, {
        widgetDetailLoading: false,
        widgetDetailLoaded: true,
        widgetDetailFailed: false,
        widgetDetail: payload.data,
      });
    }

    case actions.ActionTypes.WIDGET_DETAIL_FAIL: {
      return Object.assign({}, state, {
        widgetDetailLoading: false,
        widgetDetailLoaded: false,
        widgetDetailFailed: true,
      });
    }



    case actions.ActionTypes.WIDGET_DETAIL_COUNT: {
      return Object.assign({}, state, {
        widgetDetailCountLoading: true,
        widgetDetailCountLoaded: false,
        widgetDetailCountFailed: false,
      });
    }

    case actions.ActionTypes.WIDGET_DETAIL_COUNT_SUCCESS: {
      return Object.assign({}, state, {
        widgetDetailCountLoading: false,
        widgetDetailCountLoaded: true,
        widgetDetailCountFailed: false,
        widgetDetailCount: payload.data,
      });
    }

    case actions.ActionTypes.WIDGET_DETAIL_COUNT_FAIL: {
      return Object.assign({}, state, {
        widgetDetailCountLoading: false,
        widgetDetailCountLoaded: false,
        widgetDetailCountFailed: true,
      });
    }
    ...
    case actions.ActionTypes.GET_PRODUCTSEARCH_LIST: {
      if (payload.keyUp === 'true') {
        state.getProductSearch = [];
        payload.offset = 0;
      }
      return Object.assign({}, state, {
        getProductSearchLoading: true,
    ...
    case actions.ActionTypes.GET_PRODUCTSEARCH_LIST_SUCCESS: {
      ...
      productListArray = state.getProductSearch ? state.getProductSearch : [];
      let concatArray = [];
    ...
    case actions.ActionTypes.CHANGE_WISHLIST_STATUS: {
      ...
      const widgetProduct = state?.widgetProductList;
      const widgetDetail = state?.widgetDetail;
      const vendorProduct = state.vendorProductList ? state.vendorProductList : [];
      const relatedProduct = state.relatedProducts ? state.relatedProducts : [];
      ...
      if (payload) {
        ...
        } else if (payload.page === 'widgetDetail') {
          if (payload.checked) {
            // widgetDetail.map(data => {
            const widgets = widgetDetail.widgetItems;
            widgets.map(items => {
              if (items.productId === payload.details.productId) {
                items.wishListStatus = 1;
              }
        ...
        } else if (payload.page === 'vendorProduct') {
          if (payload.checked) {
            vendorProduct.map(data => {
              if (data.productId === payload.details.productId) {
                data.wishListStatus = 1;
              }
            });
        ...
        else if (payload.page === 'relatedProduct') {
          if (payload.checked) {
            relatedProduct.map(element => {
              if (element.productId === payload.details.productId) {
                element.wishListStatus = 1;
              }
            });
          } else {
            relatedProduct.map(element => {
              if (element.productId === payload.details.productId) {
                element.wishListStatus = 0;
              }
            });
          }
        }
...
export const widgetDetail = (state: ListsState) => state.widgetDetail;
export const widgetDetailLoading = (state: ListsState) => state.widgetDetailLoading;
export const widgetDetailLoaded = (state: ListsState) => state.widgetDetailLoaded;
export const widgetDetailFailed = (state: ListsState) => state.widgetDetailFailed;


export const widgetDetailCount = (state: ListsState) => state.widgetDetailCount;
export const widgetDetailCountLoading = (state: ListsState) => state.widgetDetailCountLoading;
export const widgetDetailCountLoaded = (state: ListsState) => state.widgetDetailCountLoaded;
export const widgetDetailCountFailed = (state: ListsState) => state.widgetDetailCountFailed;
